# Adopted from Kokkos Kernels (https://github.com/kokkos/kokkos-kernels)
#
# @FUNCTION: DIVERG_ETI_MAKE_LIST
#
...
# DIVERG_ETI_MAKE_LIST(ETI_FOR_T TYPE_LISTS INDEX FLOAT)
...
FUNCTION(DIVERG_ETI_MAKE_LIST ETI_LIST_NAME)
...
ENDFUNCTION(DIVERG_ETI_MAKE_LIST)

MACRO(DIVERG_GENERATE_ETI FUNCTION_NAME SUBFOLDER)
  CMAKE_PARSE_ARGUMENTS(ETI
    ""
  ...
  SET(ETI_AVAIL_MACRO "DIVERG_${UPPER_NAME}_ETI_SPEC_AVAIL")
  SET(ETI_INST_MACRO  "DIVERG_${UPPER_NAME}_ETI_SPEC_INST")
  ...
  IF (ETI_COMP_IS_ENABLED)
    ...
    DIVERG_ETI_MAKE_LIST(${FUNCTION_NAME}_eti TYPE_LISTS ${ETI_TYPE_LISTS})
    FOREACH(ETI ${${FUNCTION_NAME}_eti})
      ...
      SET(INST_SOURCE   "${ETI_COMPONENTS}/${SUBFOLDER}/${ETI}.cpp")
      SET(INST_TEMPLATE "${ETI_COMPONENTS}/${SUBFOLDER}/DiverG${FUNCTION_NAME}_eti_spec_inst.cpp.in")
  ...
  SET(AVAIL_HEADER   "include/diverg/basic_types.hpp")
  ...
  CONFIGURE_FILE(${PROJECT_SOURCE_DIR}/${AVAIL_TEMPLATE}
      ${PROJECT_SOURCE_DIR}/${AVAIL_HEADER})

  LIST(APPEND ${ETI_HEADER_LIST} ${CMAKE_CURRENT_BINARY_DIR}/${AVAIL_HEADER})
ENDMACRO(DIVERG_GENERATE_ETI)
